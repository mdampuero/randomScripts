var __require=(function(){/** vim: et:ts=4:sw=4:sts=4
...
if(context){context.defQueue.push([name,deps,callback]);context.defQueueMap[name]=!0}else{globalDefQueue.push([name,deps,callback])}};define.amd={jQuery:!0};req.exec=function(text){return eval(text)};define("jquery",[],function(){return window.jQuery});req(cfg)}(this,(typeof setTimeout==='undefined'?undefined:setTimeout)));return{requirejs:requirejs,require:require,define:define}})()